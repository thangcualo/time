...
Dùng wget:
```
wget --no-check-certificate "https://raw.githubusercontent.com/thangcualo/time/main/times-openwrt" -O /usr/bin/times-openwrt && chmod +x /usr/bin/times-openwrt
```

dùng curl:
```

curl -sL https://raw.githubusercontent.com/thangcualo/time/main/times-openwrt > /usr/bin/times-openwrt && chmod +x /usr/bin/times-openwrt
```
